...
const schema = Joi.object().keys({
  ...
  module.exports = async function (context, req) {
    ...
    const { jira_project_key, jira_issueNumber_dev ,  deployment_date_prod , jira_issueNumber_prod, job_link_prod } = context.req.body;
  
    const tableData = {
      partitionKey: jira_project_key,
      rowKey: jira_issueNumber_dev,
      deployment_date_prod: deployment_date_prod,
      issuekey_prod: jira_issueNumber_prod,
